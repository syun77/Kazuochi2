...
import jp_2dgames.game.AssetPaths;
...
class MyButton extends FlxTypedButton<FlxText>
{
	...
	private inline function initLabel(Text:String):Void 
	{
		if (Text != null)
		{
			label = new FlxText(x + labelOffsets[NORMAL].x, y + labelOffsets[NORMAL].y, 120, Text);
...
//		loadDefaultGraphic();
		loadGraphic(AssetPaths.IMAGE_BUTTON, true, 120, 32);
